...
{
    public override string Type => ConditionType.CondAnd;

    public override CondAnd DeserializeDto(ConditionDto dto, Type stateType, ConditionDeserializer deserializer)
    {
